...
//				p2.playSound(p2.getLocation(), Sound.valueOf(plugin.getSettingsHandler().getResultSplitSound()), 2F, 1F);
//			p2.sendMessage(plugin.getSettingsHandler().getHeChosedSplit().replace("%player%", p1.getName()));
//			
//		} else {
...
//				p2.playSound(p2.getLocation(), Sound.valueOf(plugin.getSettingsHandler().getResultStealSound()), 2F, 1F);
//			p2.sendMessage(plugin.getSettingsHandler().getHeChosedSteal().replace("%player%", p1.getName()));
//		}
//		
//		if (p2choice.equals("split")) {
//			arena.getResultSpot2().getBlock().setType(plugin.getSettingsHandler().getSplitMaterial());
//			if (!plugin.getSettingsHandler().getResultSplitSound().equals("none"))
//				p1.playSound(p1.getLocation(), Sound.valueOf(plugin.getSettingsHandler().getResultSplitSound()), 2F, 1F);
//			p1.sendMessage(plugin.getSettingsHandler().getHeChosedSplit().replace("%player%", p2.getName()));
//		} else {
//			arena.getResultSpot2().getBlock().setType(plugin.getSettingsHandler().getStealMaterial());
//			if (!plugin.getSettingsHandler().getResultStealSound().equals("none"))
//				p1.playSound(p1.getLocation(), Sound.valueOf(plugin.getSettingsHandler().getResultStealSound()), 2F, 1F);
//			p1.sendMessage(plugin.getSettingsHandler().getHeChosedSteal().replace("%player%", p2.getName()));
//		}
