package tr.thelegend.splitshare.commands;
...
public class Splitshare implements CommandExecutor {
	
	private SettingsHandler config;
	private Main plugin;
	
	public Splitshare(Main plugin) {
		this.plugin=plugin;
	...
	public boolean onCommand(CommandSender gonderen, Command komut, String label, String[] args) {
		...
		if (komut.getName().equalsIgnoreCase("splitshare")) {
			
			if (args.length==0) {
				if (!gonderen.hasPermission("splitshare.main")) {
			...
			if (args[0].equalsIgnoreCase("send")) {
				...
				if (!gonderen.hasPermission("splitshare.send")) {
					gonderen.sendMessage(config.getNoPerm());
					return false;
				}
			...
			if (args[0].equalsIgnoreCase("arena")) {
				...
				if (!gonderen.hasPermission("splitshare.arena")) {
					gonderen.sendMessage(config.getNoPerm());
					return false;
				}
			...
			if (args[0].equalsIgnoreCase("setup")) {
				...
				if (args[1].equalsIgnoreCase("create")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.create")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("delete")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.delete")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("setpos1")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.setpos1")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("setspawn")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.setspawn")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("setpos2")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.setpos2")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("setresult1")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.setresult1")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("setresult2")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.setresult2")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
				...
				if (args[1].equalsIgnoreCase("addbutton")) {
					...
					if (!gonderen.hasPermission("splitshare.setup.addbutton")) {
						gonderen.sendMessage(config.getNoPerm());
						return false;
					}
